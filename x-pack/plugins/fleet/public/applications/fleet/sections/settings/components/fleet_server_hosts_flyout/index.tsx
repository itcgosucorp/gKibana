      ...
      <EuiFlyoutBody>
        ...
        >
          <FormattedMessage
            ...
            defaultMessage="Invalid settings can break the connection between gExplorer Agent and Fleet Server. If this happens, you will need to re-enroll your agents."
          />
        </EuiCallOut>
        <EuiSpacer size="m" />
